...
export default function TTSVoiceSelect({ specificVoiceSettingsActions, selectedCategory, setSelectedCategory, voices, voice, setVoice, setResultsAmount, totalVoicesLength, resultsAmount }) {
